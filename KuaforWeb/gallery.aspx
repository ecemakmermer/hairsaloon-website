<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gallery.aspx.cs" Inherits="KuaforWeb.gallery" %>
...
<header>
	<div class="container">
		...
		<nav class="py-md-4 py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href="Default.aspx"><span class="fa fa-scissors"></span> Men's Salon</a></h1>
			</div>
...
<footer class="py-sm-5 py-4">
	<div class="container py-md-3">
		<div class="footer-logo text-center">
			<a class="navbar-brand" href="Default.aspx"><span class="fa fa-scissors"></span>Men's Salon</a>
		</div>
